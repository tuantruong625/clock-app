  ...
  return (
    showTimeDetails ?
      <div className="details-container col-span-full bg-gray-100 sm:p-24 sm:py-0">
        <div className="p-8 sm:px-0 grid grid-cols-1 sm:grid-cols-2">
        ...
        <div className="p-8 pb-2 sm:px-0 grid grid-cols-1 sm:grid-cols-2">
          <p className="text-gray-400 uppercase flex justify-between text-xs py-3 tracking-wide sm:flex-col items-baseline">
            current time zone
